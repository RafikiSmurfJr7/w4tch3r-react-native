...
export default function FilmeDetailScreen({ route }) {
  ...
  useEffect(() => {
    const fetchMovieData = async () => {
      try {
        const response = await tmdbApi.get(`/movie/${route.params.id}`);
            ...
            >
              ...
              <View style={styles.movieInfoContainer}>
                ...
                <View style={{ alignSelf: "center", width: 150 }}>
                  ...
                  <Text style={styles.movieInfoText}>
                    Linguagem: {movieData.original_language.toUpperCase()}{" "}
                  </Text>
                  <Text style={styles.movieInfoText}>
                    Genre:{" "}
              ...
              <View style={styles.movieDescriptionContainer}>
                <Text style={styles.movieWatchTitle}>Overview:</Text>
